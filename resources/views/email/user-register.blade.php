        ...
        <div class="min-h-screen">
            ...
            <main class="p-20">
                <div class="mt-4 p-4 max-w-lg text-center space-y-4 bg-white rounded-lg border shadow-md sm:p-8 dark:bg-gray-800 dark:border-gray-700 mx-auto">
                    ...
                    <p class="text-base text-gray-700 sm:text-lg dark:text-gray-400 font-bold">  <h2>¡Bienvenido, {{ $name }}!</h2></p>
                ...
                <p>Tu cuenta ha sido creada exitosamente.</p>
                        ...
                        <hr>
                    <div>
                        <p>Para ver más detalles, por favor visita nuestro sitio web:</p>
                        <br>
